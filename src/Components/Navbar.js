      ...
      <nav className="relative flex w-full flex-wrap items-center justify-between bg-gray-100 py-3.5 text-gray-500 shadow-md hover:text-gray-700 focus:text-gray-700">
        <div className="container-fluid flex w-full flex-wrap items-center px-3">
          <Link to="/" onClick={() => setSearch('')}>
            <div className="mr-1 flex items-center text-black hover:text-gray-800">
              <img
          ...
          <input
            type="text"
            id="search-navbar"
            className="mr[1rem] absolute ml-[12rem] w-[50%] rounded-lg border border-gray-300 bg-gray-200 pt-2.5 pb-2 pl-4 placeholder-gray-500 focus:border-blue-500 focus:ring-blue-500 md:left-0 md:right-0 md:mx-auto lg:w-[30%]"
            placeholder="Search..."
